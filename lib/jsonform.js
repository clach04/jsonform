...
jsonform.fieldTemplate = function(inner) {
  return '<div ' +
    ...
    '<% }%>' +
    'class="form-group mb-3 jsonform-error-<%= keydash %>' +
    ...
    '<div class="controls">' +
      ...
      '<div class="<% if (node.prepend) { %>input-group mb-3<% } %>' +
        '<% if (node.append) { %> input-group mb-3<% } %>">' +
        '<% if (node.prepend) { %>' +
          '<span class="input-group-text"><%= node.prepend %></span>' +
        '<% } %>' +
      '<% } %>' +
      inner +
      '<% if (node.append) { %>' +
        '<span class="input-group-text"><%= node.append %></span>' +
      '<% } %>' +
      '<% if (node.prepend || node.append) { %>' +
        '</div>' +
      '<% } %>' +
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<span class="_jsonform-array-buttons">' +
        '<a href="#" class="btn btn-outline-secondary _jsonform-array-addmore"><i class="bi bi-file-plus" style="font-size: 2rem;" title="Add new"></i></a> ' +
        '<a href="#" class="btn btn-outline-secondary _jsonform-array-deletelast"><i class="bi bi-file-minus" style="font-size: 2rem;" title="Delete last"></i></a>' +
      '</span>' +
      '</div>',
    'fieldtemplate': true,
    'array': true,
    'childTemplate': function (inner, enableDrag) {
      if ($('').sortable) {
        ...
        return '<li data-idx="<%= node.childPos %>">' +
          ...
          (enableDrag ? '<span class="draggable line"><i class="bi bi-list" style="font-size: 2rem;" title="Move item"></i></span>' : '') +
          inner +
          '<span class="_jsonform-array-buttons">' +
            '<a href="#" class="btn btn-outline-secondary _jsonform-array-deletecurrent"><i class="bi bi-file-minus" style="font-size: 2rem;" title="Delete current"></i></a>' +
          '</span>' +
          '</li>';
      }
      else {
